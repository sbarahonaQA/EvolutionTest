...
Característica: GruposCorporativos
  ...
  Escenario: Crear un grupo corporativo con información básica (PDS-1531)
    ...
    * Se cargan elementos de la pagina dev/evolution/organizacion/estructura_organizativa/GruposCorporativos.json
    * Click a Nuevo
    * Llenar formulario:
    ...
    * Se cargan elementos de la pagina dev/evolution/configuracion/seguridad_acceso/SeguridadDeAcceso.json
    * Click a AsignacionPermisosSeguridadContenido
    * Se cargan elementos de la pagina dev/evolution/configuracion/seguridad_acceso/AsignacionPermisosSeguridadContenido.json
